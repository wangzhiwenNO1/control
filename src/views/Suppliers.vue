    ...
    <el-row>
        <el-col :span="2">
            <div class="supplierLeftBox">
                ...
                <div class="addBox" :class="type==4?'active':''" @click="changeType(4)">
        ...
        <el-col :span="10">
            ...
            <div class="information">
                ...
                <div class="text">{{providertext}}</div>
                <div class="infoBtn">
    ...
    export default {
        ...
        methods: {
          ...
          getprovidertext(){
            ...
            this.Axios.get("/lab2lab/v1/requestor/getprovidertext", {
              id:10
            }).then(function (res) {
              console.log("供应商文本介绍",res);
              that.providertext=res.data.introduction;
            })
          },
